(function($) {
    ...
    $js.fn.extend({
        ...
        select: function(idx) {
            ...
            if (e) {
                ...
                var tmp1 = $('.jspotlite-spotlite-content', this.spotlite);
                var tmp2 = $('<div>').html($(".feature", e).html())
                    .addClass('jspotlite-spotlite-content')
                    // This css is convenient but should probably be in style sheet.
                    .appendTo($(this.spotlite));

                $js.animate(this.options.spotlite, tmp1, tmp2);
                return true;
            }
            return false;
        },
    ...
    $.jspotlite.animation = {
        ...
        animate: function (o, e1, e2) {
            if ($js.defaultTest(e2)) {
                o.hide = $.extend(true, o.options, o.hide || {});
                o.show = $.extend(true, o.options, o.show || {});
        ...
        uiEffect: function (o, e1, e2) {
            if ($js.defaultTest(e2)) {
                o.hide = $.extend(true, o.options, o.hide || {});
                o.show = $.extend(true, o.options, o.show || {});
                var show = o.show.name || o.name;
                var hide = o.hide.name || o.name;
